...
extract_translations: ## extract strings to be translated, outputting .mo files
	rm -rf docs/_build
	cd adaptive-learning-plugin && ../manage.py makemessages -l en -v1 -d django
	cd adaptive-learning-plugin && ../manage.py makemessages -l en -v1 -d djangojs

compile_translations: ## compile translation files, outputting .po files for each supported language
	cd adaptive-learning-plugin && ../manage.py compilemessages

detect_changed_source_translations:
	cd adaptive-learning-plugin && i18n_tool changed
...
dummy_translations: ## generate dummy translation (.po) files
	cd adaptive_learning_plugin && i18n_tool dummy
