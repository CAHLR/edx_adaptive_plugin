...
"""
adaptive-learning-plugin documentation build configuration file.
...
project = 'adaptive-learning-plugin'
copyright = edx_theme.COPYRIGHT  # pylint: disable=redefined-builtin
author = edx_theme.AUTHOR
project_title = 'Adaptive  Learning Plugin'
...
#
# html_title = 'adaptive-learning-plugin v0.1.0'
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'adaptive_learning_plugin'),
                os.path.join(root_path, 'adaptive_learning_plugin/migrations')])
